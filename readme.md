...
- [next.js-typescript-boilerplate](https://github.com/deptno/next.js-typescript-boilerplate) - next.js + redux + typescript, simple configuration for SEO, analytics. you can use styled-jsx in tsx.
