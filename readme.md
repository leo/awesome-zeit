...
- [zeit-deployments](https://github.com/pranaygp/zeit-deployments) - *deprecated* - Deploy a tiny Next.js app to Vercel that lists all your Vercel deployments.
- [now-env](https://github.com/sergiodxa/now-env) - *deprecated* Use now.json environment variables and secrets in development.
- [now-ab](https://github.com/sergiodxa/now-ab) - *deprecated* AB test two or more Now deployments with a simple deploy.
...
- [now-client](https://github.com/zeit/now-client) - *deprecated* - Now's JavaScript client for their API.
...
- [nash](https://github.com/littleStudent/now_dashboard) - *deprecated* A web [dashboard](https://nash.now.sh) to manage deployments, aliases and secrets.
...
- [ipinfo.now.sh](https://github.com/GitSquared/ipapi) - *deprecated* Fast & reliable geoip API powered by Now.
